      ...
      <div className="pt-15">
        ...
        <div className="flex" style={{ minHeight: 'calc(100dvh - 220px)' }}>
          ...
          <aside className="w-[240px] shrink-0 border-r px-5 py-6 overflow-y-auto" style={{ background: 'var(--hh-bg2)', borderColor: 'var(--hh-border)' }}>
            ...
            <HHButton onClick={() => setFilters(DEFAULT_FILTERS)} className="mt-5 w-full">
              Reset filters
            </HHButton>
          </aside>
          ...
          <div className="flex-1 min-w-0 px-6 py-5 overflow-y-auto">
            ...
            <div className="flex items-center justify-center gap-1.5 mt-7" aria-label="Pagination">
              <button type="button" onClick={() => setPage(p => Math.max(1, p - 1))} disabled={page === 1} aria-label="Previous page" className={cn('flex h-[34px] w-[34px] cursor-pointer items-center justify-center rounded-[8px] border text-[16px] transition-all duration-150 disabled:opacity-30 disabled:cursor-not-allowed')} style={{ background: 'transparent', borderColor: 'var(--hh-border)', color: 'var(--hh-txt2)' }}>
              ...
              >{TOTAL_PAGES}</button>
              <button type="button" onClick={() => setPage(p => Math.min(TOTAL_PAGES, p + 1))} disabled={page === TOTAL_PAGES} aria-label="Next page" className={cn('flex h-[34px] w-[34px] cursor-pointer items-center justify-center rounded-[8px] border text-[16px] transition-all duration-150 disabled:opacity-30 disabled:cursor-not-allowed')} style={{ background: 'transparent', borderColor: 'var(--hh-border)', color: 'var(--hh-txt2)' }}>
