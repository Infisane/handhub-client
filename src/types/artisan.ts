...
export const ARTISANS: Artisan[] = [
	{
		...
		reviews: [
			{
				stars: 5,
				text: "Fixed my tripped breaker in under an hour. Professional and clean.",
				by: "Adeola K.",
			},
			{
				stars: 5,
				text: "Quick response at midnight. Truly reliable.",
				by: "Bode A.",
			},
		],
	},
	{
		...
		reviews: [
			{
				stars: 5,
				text: "Sorted my leaking pipes quickly. Would hire again.",
				by: "Chidi O.",
			},
	...
	},
	{
		...
		reviews: [
			{
				stars: 5,
				text: "Made a beautiful wardrobe exactly to my specs.",
				by: "Ngozi C.",
			},
			{
				stars: 4,
				text: "Quality work but took slightly longer than estimated.",
				by: "Seun A.",
			},
		],
	},
	{
		...
		reviews: [
			{
				stars: 5,
				text: "Serviced 3 units in one visit. Very thorough.",
				by: "Amaka I.",
			},
			{
				stars: 5,
				text: "Fixed my AC in 45 mins. Worth every naira.",
				by: "Tunde F.",
			},
		],
	},
	{
		...
		reviews: [
			{
				stars: 5,
				text: "Transformed my living room. Excellent finish.",
				by: "Kemi L.",
			},
	...
	},
	{
		...
		reviews: [
			{
				stars: 5,
				text: "Laid my bathroom tiles perfectly. Zero grout issues.",
				by: "Dele M.",
			},
			{
				stars: 5,
				text: "Super professional. Floor looks amazing.",
				by: "Sola K.",
			},
		],
	},
	{
		...
		reviews: [
			{
				stars: 5,
				text: "Built my gate exactly as designed. Strong work.",
				by: "Hassan A.",
			},
			{
				stars: 4,
				text: "Good welder. Finished ahead of schedule.",
				by: "Ifeanyi O.",
			},
		],
	},
	{
		...
		reviews: [
			{
				stars: 5,
				text: "Diagnosed my gen fault in minutes. Very knowledgeable.",
				by: "Tobi A.",
			},
			{
				stars: 5,
				text: "Fixed my inverter same day. Highly recommend.",
				by: "Bukky O.",
			},
		],
	},
	{
		...
		reviews: [
			{
				stars: 5,
				text: "Installed my solar setup perfectly. Very professional.",
				by: "Emeka S.",
			},
			{
				stars: 5,
				text: "Fixed my wiring fault fast. Knowledgeable and clean.",
				by: "Adaeze T.",
			},
		],
	},
