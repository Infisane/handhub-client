...
export function ArtisanCard({ artisan: a, onView }: ArtisanCardProps) {
  ...
  return (
    <article
      ...
      onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(232,80,10,0.35)' }}
      onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor = 'var(--hh-border)' }}
    >
      {/* Verified badge */}
      <div
      ...
      <div className="flex items-start gap-3 mb-3.5">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[14px] font-medium truncate" style={{ color: 'var(--hh-txt)' }}>{a.name}</p>
          <p className="text-[11.5px] mt-0.5" style={{ color: 'var(--hh-txt3)' }}>{a.role}</p>
          <div className="flex items-center gap-1 mt-1 text-[11.5px]" style={{ color: 'var(--hh-txt3)' }}>
      ...
      <div className="flex gap-3.5 mb-3.5">
        <div className="flex items-center gap-1 text-[12px]" style={{ color: 'var(--hh-txt3)' }}>
          <Star size={13} fill="#F59E0B" style={{ color: '#F59E0B' }} aria-hidden />
      ...
      <div className="flex gap-1.5 flex-wrap mb-3.5">
        {a.tags.map(t => (
          <span
            ...
            style={{ background: 'rgba(255,255,255,0.05)', borderColor: 'var(--hh-border)', color: 'var(--hh-txt3)' }}
          >
            {t}
          </span>
        ))}
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <span className="text-[11px] ml-0.5" style={{ color: 'var(--hh-txt3)' }}>/hr</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="flex items-center text-[11.5px]" style={{ color: 'var(--hh-txt3)' }}>
            <span
          ...
          <button
            ...
            style={{ background: 'rgba(232,80,10,0.08)', borderColor: 'rgba(232,80,10,0.2)', color: 'var(--hh-or)' }}
            onMouseEnter={e => {
